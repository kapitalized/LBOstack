  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Step 3 of the wizard: review the 5-year cashflow schedule generated from your deal and funding inputs.</p>
      </div>
      ...
      <section className="rounded-xl border bg-card p-4">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-4">
          ...
          <div className="rounded-lg border p-3">
            ...
            <p className="mt-1 text-sm font-semibold">{formatMoney(state.deal.purchasePrice || state.totalFundingNeeds)}</p>
          </div>
          <div className="rounded-lg border p-3">
            <p className="text-xs text-muted-foreground">Entry EBITDA</p>
            <p className="mt-1 text-sm font-semibold">{formatMoney(state.deal.entryEbitda)}</p>
          </div>
          <div className="rounded-lg border p-3">
            <p className="text-xs text-muted-foreground">Horizon</p>
            <p className="mt-1 text-sm font-semibold">{state.model.periodYears} years</p>
          </div>
        </div>
      </section>
